...
export default class Keyboardlayout extends styleableContainerComponentMixin(FlexLayout) {
...
class $Keyboardlayout$$FlNavigation extends styleableContainerComponentMixin(FlexLayout) {
...
class $Keyboardlayout$$FlNavigation$$ImgUp extends styleableComponentMixin(ImageView) {
  static $$styleContext: ComponentStyleContext = {
...
class $Keyboardlayout$$FlNavigation$$ImgDown extends styleableComponentMixin(ImageView) {
  static $$styleContext: ComponentStyleContext = {
